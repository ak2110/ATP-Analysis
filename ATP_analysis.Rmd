...
2. Date - Date on which the match was played.
...
4. Court - The type of the court on which the match was played. Can be either Indoor or Outdoor.
...
14. Tournament_Winner - The player name of winner of the match is set as the column value if it was the final round of the tournament. Or else set to NA.
